...
def wrench_publisher():
    ...
    while not rospy.is_shutdown():
        ...
        # y 방향 힘을 사인 함수로 변화
        # wrench_stamped.wrench.force.z = gain * math.sin(ramda * math.pi * (current_time - start_time))
        wrench_stamped.wrench.force.z = offset + gain * math.sin(ramda * math.pi * (current_time - start_time))
